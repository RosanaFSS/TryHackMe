...
>>> <code>-r</code> uses the intercepted request you saved earlier
>>> <code>--dbms</code> tells SQLMap what type of database management system it is
>>> <code>--dump</code> attempts to outputs the entire database
