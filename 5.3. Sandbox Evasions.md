...
Note: If your DNS check has if(dcNewName.find("\\")) instead of if(dcNewName.find("\\\\")) then you may have difficulties with the sleep check.</em><br><a id='5.1'></a>____________No answer needed</strong></code>
