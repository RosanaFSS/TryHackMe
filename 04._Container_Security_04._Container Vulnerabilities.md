...
<p>Before proceeding, it is strongly recommended that you have completed the <a href="https://tryhackme.com/r/room/introtodockerk8pdqk">Intro to DevSecOps</a> room and are comfortable with the Linux CLI.</p>

<p>Namely, by the end of the room, you will be familiar with the following:
<ul style="list-style-type:square">
    <li>The basic syntax to get you started with Docker</li>
    <li>The basic syntax to get you started with Docker</li>
    <li>The basic syntax to get you started with Docker</li>
    <li>The basic syntax to get you started with Docker</li>
    <li>The basic syntax to get you started with Docker</li>
    <li>Applying the knowledge gained from the room into the practical element at the end.</li>
</ul></p>
