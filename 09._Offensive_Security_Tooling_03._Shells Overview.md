...
> 7.1 - <em>Using a reverse or bind shell, exploit the command injection vulnerability to get a shell. What is the content of the flag saved in the / directory?</em>
>> <strong>_______________</strong>
<p></p><br>
