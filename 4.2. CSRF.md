...
Then used <code>Inspect</code>, after clicked in <code>Storage</code> and added </p> <code>isBanned</code> as <em>Cookie Name</em> and the same <em>Cookie Value</em> present in the <code>Online Banking</code> page in <code>Chrome</code>.</p>
