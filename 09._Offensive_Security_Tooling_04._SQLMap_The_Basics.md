...
<pre><code>$http://[REDACTED]/ai/includes/user_login?email=rosana@local.com&password=test
</code></pre>

http://10.10.198.123/ai/includes/user_login?email=rosana@local.com&password=test
